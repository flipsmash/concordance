...
AUTHOR_RUBRIC = (
    ...
    "8-9 = Charles Dickens, Mark Twain, Edgar Allan Poe (major canonical "
    "figures, widely read and taught, a rung below the very top). "
...
BOOK_RUBRIC = (
    ...
    "person has heard of). "
    "8-9 = a major canonical novel widely taught in schools (e.g. Great "
    "Expectations). "
